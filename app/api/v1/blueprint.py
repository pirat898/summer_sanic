...
api_v1_blueprint.add_route(update_user_by_id_method, uri='/users/<user_id>')
api_v1_blueprint.add_route(add_user_method, uri='/users')
api_v1_blueprint.add_route(delete_user_by_id_method, uri='/users/<user_id>')
